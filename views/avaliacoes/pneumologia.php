            ...
            <div class="div-agenda x_panel">
                ...
                <div class="x_content">    
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="tosse" name="tosse">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="aspecto-secrecao" name="aspecto-secrecao">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="musculatura-acessoria" name="musculatura-acessoria">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="batimento-asa-nariz" name="batimento-asa-nariz">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="presenca-triagem-intercostal" name="presenca-triagem-intercostal">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="predominio-respiratoria" name="predominio-respiratoria">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="morfologia-toracica" name="morfologia-toracica">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="expansibilidade-toracica" name="expansibilidade-toracica">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="ritmo-respiratorio" name="ritmo-respiratorio">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="dispineia-escala-mrc" name="dispineia-escala-mrc">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="presenca-deformidades-posturais" name="presenca-deformidades-posturais">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="mobilidade-toracica" name="dispineia-escala-mrc">
                                <option>Selecione</option>
            ...
            <div class="div-agenda x_panel">
                ...
                <div class="validacao x_content">                    
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="diafragma" name="diafragma">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="intercostais" name="intercostais">
                                <option>Selecione</option>
                                <option value="1">Direito</option>
                                <option value="2">Esquerdo</option>                            
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="axilar" name="axilar">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="mamilar" name="mamilar">
                                <option>Selecione</option>
                                <option value="1">Normal</option>
                                <option value="2">Insp Max</option>                                
                                <option value="3">Exp Max</option>                          
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="ultimos-arcos-costais" name="ultimos-arcos-costais">
                                <option>Selecione</option>
                                <option value="1">Normal</option>
                                <option value="2">Insp Max</option>                                
                                <option value="3">Exp Max</option>                        
            ...
            <div class="div-agenda x_panel">
                ...
                <div class="validacao x_content">                    
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="cpp-mv" name="cpp-mv">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="ruidos-secos" name="ruidos-secos">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="ruidos-umidos" name="ruidos-umidos">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="motora-tonus" name="motora-tonus">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="trofismo" name="trofismo">
                                <option>Selecione</option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="cicatrizes" name="cicatrizes">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="cianose" name="cianose">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="hematoma" name="hematoma">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="eritema" name="eritema">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="edema" name="edema">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8">
                            <select class="validacao form-control" id="alteracao-temperatura" name="alteracao-temperatura">
                                <option>Selecione</option>
                                <option value="1">Sim</option>
                                <option value="2">Não</option>                                
                            </select>
