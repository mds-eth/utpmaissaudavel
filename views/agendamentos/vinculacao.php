<div class="form-horizontal">   
    <div class="row">
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h5><b>Pacientes cadastrados, sem agendamento</b></h5>            
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h5><b>Legenda para o agendamento</b></h5>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <?php foreach ($cores as $cor): ?> 
                            <span style="color: <?= $cor['cor'] ?>"><b><?= $cor['especialidade'] ?></b></span><br>
                        <?php endforeach; ?>                            
                    </div>                                   
                </div>              
            </div>    
        ...
        <div class="col-md-6 col-sm-12 col-xs-12" style="height: 100px">
            <div class="x_panel">
                <div class="x_title">
                    <h5><b>Agenda</b></h5>                
                    <div class="clearfix"></div>
