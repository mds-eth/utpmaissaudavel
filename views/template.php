...
<html lang="pt-br">
    <head>
        ...
        <script type="text/javascript" src="<?php echo URL; ?>/assets/js/libs/jquery/jquery-1.12.js"></script>
        <script type="text/javascript" src="<?php echo URL; ?>/assets/js/libs/jquery/jquery-ui.js"></script>        
