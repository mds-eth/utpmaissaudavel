<?php if ($_SESSION['usuario']['id_perfil'] == Perfis::ALUNO) : ?>
    ...
    <script type="text/javascript" src="<?php echo URL; ?>/assets/js/home/aluno.js"></script>
<?php endif; ?>
<?php if ($_SESSION['usuario']['id_perfil'] == Perfis::SECRETARIA || $_SESSION['usuario']['id_perfil'] == Perfis::FISIOTERAPEUTA): ?>
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
